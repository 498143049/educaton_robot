 ...
 * @note   Declared as macro 
 */
#define ESP8266_RESET_LOW     HAL_GPIO_WritePin(SERIAL_CTL_GPIO_Port, SERIAL_CTL_Pin, GPIO_PIN_RESET)
 ...
 * @note   Declared as macro 
 */
#define ESP8266_RESET_HIGH    HAL_GPIO_WritePin(SERIAL_CTL_GPIO_Port, SERIAL_CTL_Pin, GPIO_PIN_SET)
